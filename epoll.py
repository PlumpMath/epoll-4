...
serversocket.bind(('127.0.0.1', 8073))
    ...
    while True:
        ...
        for fileno, event in events:
            ...
            if fileno == serversocket.fileno():
                ...
                epoll.register(connection.fileno(), select.EPOLLIN)   #5
                connections[connection.fileno()] = connection  #5
                print connections
                # 初始化接收的数据
                requests[connection.fileno()] = b''   #5
                print requests
                print "client和server建立连接完成"
